...
export default function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(user.role === 'admin' ? '/admin/dashboard' : '/concerts');
    } catch (err: any) {
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center">
              <input type="checkbox" className="w-4 h-4 rounded border-gray-600 text-red-600 focus:ring-red-500 focus:ring-2 bg-gray-700 border-gray-600" />
